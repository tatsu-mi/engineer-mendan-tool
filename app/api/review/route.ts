...
会話ログの候補者発言（画面上の「あなた」）は音声文字起こしであり、誤認識を含む可能性があります。一方、AI面接官は各回答を理解したうえで、その直後の発言の最初の一文に回答内容を自然な表現で復唱しています。評価では、このAI面接官による復唱を一次情報として最も重く扱い、候補者発言の文字起こしは文脈確認のための参考情報としてのみ扱ってください。
...
- 候補者の経験・実績・スキルの判定は、候補者発言そのものより、その直後のAI面接官による復唱を優先する
- AI面接官の質問、案件説明、逆質問への回答は候補者の実績ではないため、候補者の発言として評価しない
- AI面接官の復唱に含まれない候補者発言の情報は参考程度にとどめ、重要な加点・減点の根拠にしない
- AI面接官の復唱と候補者発言が食い違う場合は、AI面接官の復唱を採用する
- 候補者発言に見られる誤字、脱字、不自然な語句、同音異義語、固有名詞の表記揺れ、言い間違いに見える箇所は、音声の聞き取り・文字起こし精度に起因するものとして扱い、技術力・コミュニケーション・態度・総合評価のいずれにも一切反映しない
- AI面接官の質問と、その回答後にAI面接官が述べた復唱の内容に意味上の矛盾がなければ、候補者は質問を正しく理解し、言葉の誤りなく回答したものと判断する
